...
class GooDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.training == 'test' and self.use_gtbox:
            return img, face, head_channel, eyes_loc, gaze_heatmap, gaze, gaze_inside, image_path, gtbox,eyess
        elif self.training == 'test':
            return img, face, head_channel, eyes_loc, gaze_heatmap, gaze, gaze_inside, image_path, shifted_grids, gaze_final, eyess
        else:
            return img, face, head_channel, eyes_loc, image_path, gaze_inside , shifted_grids, gaze_final
